...
INSERT INTO account VALUES ('0000000000', null, 'Технический счет'),
						   ('0100000000', null, 'Основные средства'),
						   ('0200000000', null, 'Амортизация основных средств'),
						   ('1000000000', null, 'Материалы'),
						   ('2000000000', null, 'Основное производство'),
						   ('2600000000', null, 'Общехозяйственные расходы'),
						   ('4300000000', null, 'Готовая продукция'),
						   ('5100000000', null, 'Расчетные счета'),
						   ('6000000000', null, 'Расчеты с поставщиками и подрядчиками'),
						   ('6010000000', '6000000000', 'Расчеты с поставщиками и подрядчиками авансы выданные'),
						   ('6020000000', '6000000000', 'Расчеты с поставщиками и подрядчиками'),
						   ('6200000000', null, 'Расчеты с покупателями и заказчиками'),
						   ('6210000000', '6200000000', 'Расчеты с покупателями и заказчиками авансы получены'),
						   ('6220000000', '6200000000', 'Расчеты с покупателями и заказчиками'),
						   ...
						   ('8000000000', null, 'Уставный капитал'),
						   ('8400000000', null, 'Нераспределенная прибыль (непокрытый убыток)'),
						   ('9900000000', null, 'Прибыли и убытки');
